''' 《我的自定义搞笑集锦1》 设定上传视频的配置参数 '''
''' 【注意】：集锦的配置文件与其他配置文件有所不同，文件的命名必须以 collection开头，后续功能开发将以此开头进行识别是否为集锦配置文件 '''
module_instruction = '《我的自定义搞笑集锦1》 设定上传视频的配置参数'
...
first_name = 'collectionFunny'
second_name = 'collectionFunny1'
...
video_upload_config_list = [
  {
    ...
    'upload_title': '中美剧集锦，屌丝男士+美剧硅谷，学英语看笑剧劳逸结合',
    # 类型
    'upload_type': '自制',
    # 标签
    ...
    # 简介
    'instroduction': '爆笑集锦，休闲娱乐，恰饭必备',
    # 动态
    'upload_dynamic': '搞笑片段集锦',
